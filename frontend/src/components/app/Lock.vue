<template>
  <div class="w-full px-4 py-2 my-3 xl:px-6 xl:py-4 border rounded-lg border-gray-darker  flex flex-col justify-between cursor-pointer hover:border-red" @click="engageLock()">
