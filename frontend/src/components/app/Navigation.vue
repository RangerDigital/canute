  ...
  <div class="flex flex-row">
    ...
    <div class="w-full flex flex-col justify-around">
      <div class="my-5 2xl:my-12 flex flex-col justify-around">
        <router-link class="py-4 xl:py-2 text-sm font-medium text-gray hover:text-gray-light" active-class="text-gray-light" to="/dashboard">Dashboard</router-link>
      </div>
      ...
      <div class="my-6 2xl:my-12 flex flex-col justify-around">
        <router-link class="py-4 xl:py-2 text-sm font-medium text-gray hover:text-gray-light" active-class="text-gray-light" to="/guard">Settings</router-link>
        <router-link class="py-4 xl:py-2 text-sm font-medium text-gray hover:text-gray-light" active-class="text-gray-light" to="/organisations">Organisations</router-link>
      </div>
    </div>
  </div>
</template>
