<template>
  <footer class="flex flex-row items-center justify-between lg:justify-end p-5 md:px-20 md:py-6">
    ...
    <section class="lg:hidden">
      <button class="text-sm font-base text-gray hover:text-gray-light focus:outline-none" @click="toggleLanguage()">
    ...
    <a class="text-sm font-base text-gray hover:text-gray-light cursor-pointer" href="https://bednarski.dev">Jakub Bednarski © 2021</a>
  </footer>
</template>
