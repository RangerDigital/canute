<template>
  <header class="static flex flex-row items-center justify-between p-5 md:px-20 md:py-6">
    ...
    <nav v-if="!noNav" class="items-center justify-center hidden xl:flex">
      <router-link class="text-sm mx-7 text-gray hover:text-gray-light" to="/services">{{ $t('nav.services') }}</router-link>
      <router-link class="text-sm mx-7 text-gray hover:text-gray-light" to="/faq">FAQ</router-link>
      <router-link class="text-sm mx-7 text-gray hover:text-gray-light" to="/contact">{{ $t('nav.contact') }}</router-link>
    </nav>
